...
App.prototype.retry = function(paths, tests) {
    ...
    return this._gemini.readTests(paths)
        .then(function(collection) {
            var testsToRetry = _this._calculateSuitesToRetry(tests, collection);
            console.log(testsToRetry);
...
App.prototype._calculateSuitesToRetry = function(tests, collection) {
